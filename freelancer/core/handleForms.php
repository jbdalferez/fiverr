...
if (isset($_POST['insertNewProposalBtn'])) {
	...
	// Assuming your uploaded file input name is 'image'
if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
    ...
    if ($targetDir === false) {
        ...
        // Convert to absolute path after creation
    ...
    if (move_uploaded_file($fileTmpPath, $destPath)) {
        ...
        // You can now save $newFileName to your database as the image filename
    } else {
